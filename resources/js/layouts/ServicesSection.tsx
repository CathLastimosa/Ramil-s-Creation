...
const ServicesSection = () => {
    return (
        <section id="services" className="relative px-6 py-10 pt-16 lg:px-8 lg:py-30 lg:pt-0">
            <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 lg:grid-cols-2">
                ...
                >
                    <div>
                        <h2 className="heading-3 font-heading text-black">Our Services</h2>
                        <p className="body-medium mt-4 font-body text-gray-800">
                        ...
                        return (
                            ...
                            >
                                <div className="flex justify-center overflow-hidden">
                                    <picture className="block h-[400px] w-full">
                                        <source
                                            srcSet={`${service.image.replace('.webp', '-1600.webp')}`}
                                            media="(min-width: 1024px)"
                                            type="image/webp"
                                        />
                                        <source
                                            srcSet={`${service.image.replace('.webp', '-1024.webp')}`}
                                            media="(min-width: 768px)"
                                            type="image/webp"
                                        />
                                        <source
                                            srcSet={`${service.image.replace('.webp', '-640.webp')}`}
                                ...
                                <div className="absolute bottom-0 transform p-6 text-white transition-all duration-500 group-hover:translate-y-[-5px]">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <h3 className="body-large font-heading font-semibold">{service.title}</h3>
                                    </div>
                                    <p className="body-small mt-2 max-w-md font-body text-gray-200">{service.description}</p>
                                </div>
                            </motion.div>
                        );
                    })}
